...
module tb_nce_mixed_precision_simd8_mac;
    ...
    nce_mixed_precision_simd8_mac dut (
        .clk_i                  (clk_i),
        .rst_ni                 (rst_ni),
        .clear_i                (clear_i),
    ...
    task automatic issue_operation (
        ...
        input logic [7:0] expected_invalid,
        input logic [7:0] expected_overflow,
        input logic [7:0] expected_underflow,
        input logic [7:0] expected_inexact
    );
        ...
        begin
            ...
            for (
                ...
                if (
                    ...
                    if (
                        lane_invalid_o !== expected_invalid ||
                        lane_overflow_o !== expected_overflow ||
                        lane_underflow_o !== expected_underflow ||
                        lane_inexact_o !== expected_inexact
                    ) begin
                        report_error(
    ...
    initial begin
        ...
        if (
            ...
            $fatal(
                1,
                "Mixed-precision SIMD reset state is incorrect."
            );
        end
        ...
        if (vector_file == 0) begin
            $fatal(
                1,
                "Unable to open mixed-precision SIMD vector file."
            );
        end
        ...
        // Native FP32 precision remains unsupported at this stage.
        apply_clear();
        ...
        repeat (3) begin
            ...
            if (
                ...
                report_error(
                    "Unsupported FP32 SIMD precision was accepted"
                );
            end
        end
        ...
        if (error_count == 0) begin
            $display(
                "PASS: nce_mixed_precision_simd8_mac passed %0d vectors and %0d operations.",
                vector_count,
                operation_count
            );
        end
            ...
            $fatal(
                1,
                "FAIL: %0d mixed-precision SIMD errors detected.",
                error_count
            );
        end
