...
module tb_nce_tensor_compute_subsystem;
    ...
    nce_tensor_compute_subsystem dut (
        .clk_i                          (clk_i),
        .rst_ni                         (rst_ni),
        .clear_i                        (clear_i),
    ...
    task automatic stream_load_compact_matrix (
        ...
        begin
            ...
            check_condition(
                load_words_written_o === total_words,
    ...
    initial begin
        ...
        if (error_count == 0) begin
            $display(
                "PASS: tensor compute subsystem passed all %0d checks.",
                check_count
            );
        end
        else begin
            $fatal(
                1,
                "FAIL: %0d tensor-compute-subsystem errors in %0d checks.",
                error_count,
                check_count
            );
        end
